...
<body>
    <div class="center">
        ...
        <Div class="form">
            ...
            <input type="submit" name="save" value="Save" name="" class="btn" style="background-color:red">
            <input type="submit" value="Update" name="update" class="btn"style="background-color:green">
            <input type="submit" value="Delete" name="delete" class="btn"style="background-color:blue" onclick="return checkdelete()">
            <input type="reset" value="Clear" name="" class="btn"style="background-color:orange">
        </Div>
...
<?php
 if(isset($_POST['save'])){
    ...
    $query = "INSERT INTO form (emp_name,emp_gender,emp_email,
...
<?php
 if(isset($_POST['update'])){
    ...
    $query = "UPDATE form SET emp_name='$name',emp_gender='$gender',emp_email='$email',emp_department='$department',
